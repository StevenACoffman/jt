...
var triageCmd = &cobra.Command{
	Use:   "triage",
	Short: "Transition an issue to Triage status",
	Long: `Transition an issue to Triage status`,
	Run: func(cmd *cobra.Command, args []string) {
		...
		err := atlassian.MoveIssueToStatus(jiraClient, issue, issueKey, atlassian.TriageStatusID)
		if err != nil {
			fmt.Println(err)
			os.Exit(exitFail)
		}
